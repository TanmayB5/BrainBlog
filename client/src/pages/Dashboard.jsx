        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-light-beige p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-text-medium text-sm font-medium">Total Views</p>
                  <p className="text-3xl font-bold text-text-dark">{stats.totalViews}</p>
                </div>
              ...
              <div className="mt-4 flex items-center text-sm">
                <span className="text-blue-600 font-medium">
                  {stats.totalViews} views across all blogs
                </span>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-light-beige p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-text-medium text-sm font-medium">Total Likes</p>
                  <p className="text-3xl font-bold text-text-dark">{stats.totalLikes}</p>
                </div>
              ...
              <div className="mt-4 flex items-center text-sm">
                <span className="text-pink-600 font-medium">
                  {stats.totalLikes} likes across all blogs
                </span>
              </div>
            </div>
          </div>
